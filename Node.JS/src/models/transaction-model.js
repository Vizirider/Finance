...
const INNER_JOIN_QUERY_PART = `FROM transaction INNER JOIN category ON transaction.product_category = category.id`;


export default class Transaction {
    constructor(transactionItem) {
        this.product_category = CATEGORIES.indexOf(transactionItem.product_category);
