...
public class GroupsItemViewActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(GroupsItemViewActivity.this);
